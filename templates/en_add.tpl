{make_link controller="<?=$project['controller']?>" action="add" assign="form_action"}
{form action=$form_action}
<table width="100%" border="0" cellspacing="0" cellpadding="4">
<?
if (is_array($project['add_fields'])) {
	while (list(, $field) = each($project['add_fields'])) {
?>
  <tr>
    <td><?=$project['arr_fields_names'][$field]['en_friendly_name']?></td>
    <td>
<?
